...
class Segment {
    constructor(x, y, angle, len, colour,weight, minAngle, maxAngle) {
    ...
    follow(tx, ty) {
      ...
      let dirAngle = dir.heading();
      this.angle = constrain(dirAngle, dirAngle + this.minAngle, dirAngle + this.maxAngle)
      dir.setMag(this.len);
      dir.mult(-1);
