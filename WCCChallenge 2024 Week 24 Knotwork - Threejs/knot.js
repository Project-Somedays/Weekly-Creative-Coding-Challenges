...
function twothreetorusknot(t){
    ...
    let z = 3*sin(3*t);//*cycleVariable(1,1.5, 300);
    return createVector(x,y,z);
}
...
function cycleVariable(minMult, maxMult, cycleFrames, offset = 0){
    return map(0.5*(-cos(frameCount*TWO_PI/cycleFrames + offset)+ 1),0,1,minMult,maxMult);
}
