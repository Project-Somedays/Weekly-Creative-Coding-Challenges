...
let cube, cornerMarker; // Will hold our cube object
...
function animate() {
    ...
    cornerMarker.position.copy(corner);
    
    let scl = 0.5*(-Math.cos(t*Math.PI) + 1) + 0.5;
    scaleFromPt(cube, originalPosition, corner, scl, true)
