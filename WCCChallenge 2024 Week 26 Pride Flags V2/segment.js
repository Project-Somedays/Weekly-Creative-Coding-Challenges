...
class Segment {
     ...
     * in JavaScript we instead check whether or not ty is undefined. */
      if (typeof(ty) == "undefined") {
        ...
        let targetZ = this.child.a.z;
        this.follow(targetX, targetY, targetZ);
  
      } else {
  
        let target = new p5.Vector(tx, ty, tz);
    ...
    calculateB() {
      ...
      let dz = this.len * cos(this.angle);
      this.b.set(this.a.x + dx, this.a.y + dy, this.a.z + dz);
    }
    ...
    show() {
      ...
      line(this.a.x, this.a.y, this.b.x, this.b.y, this.a.z, this.b.z);
    }
  }
