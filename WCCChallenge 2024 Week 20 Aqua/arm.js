...
class Arm {
    constructor(x, y) {
        ...
        this.relativeAnchorPt = createVector(x, y);
        this.len = maxLength;
        this.segments[0] = new Segment(0, 0, this.len, 0);
    ...
    update() {
        ...
        this.segments[0].setA(this.relativeAnchorPt);
    ...
    show() {
        push();
        translate(this.relativeAnchorPt.x, this.relativeAnchorPt.y);
